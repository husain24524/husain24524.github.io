...
//Needs to be readded once words list is complete
    ...
    if (guessString === rightGuessString) {
        ...
        document.getElementById("whatsappshare").href="whatsapp://send?text="+scoreboard+"%0a"+"Khardal Score Day 6: "+score_n+"%0a"+"www.khardal.net";
    ...
    if (guessesRemaining==1){
        ...
        if (guessesRemaining === 0) {
            ...
            document.getElementById("whatsappshare").innerHTML = `Share on Whatsapp`
            document.getElementById("whatsappshare").href="whatsapp://send?text="+scoreboard+"%0a"+"Khardal Score Day 6: "+score_n+"%0a"+"https://khardal.net/";
