...
import { WORDS1 } from "./dailywordlists/day6.js";
import { WORDSDEF } from "./dailywordlists/day6.js";
...
function modalgenerator(category){
    if (category=="firsthint"){
        ...
        document.getElementById("ModalFooterDiv").style.backgroundColor="orangered"
			...
			document.getElementById("whatsappshare").href="whatsapp://send?text="+scoreboard+"%0a"+"Khardal Score Waaz 6: "+score_n+"%0a"+"www.khardal.net";
			...
			document.getElementById("whatsappshare").innerHTML = `Share on Whatsapp`
			document.getElementById("whatsappshare").href="whatsapp://send?text="+scoreboard+"%0a"+"Khardal Score Waaz 6: "+score_n+"%0a"+"https://khardal.net/";
