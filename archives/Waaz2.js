...
import { WORDS1 } from "./dailywordlists/day2.js";
import { WORDSDEF } from "./dailywordlists/day2.js";
...
function modalgenerator(category){
    if (category=="firsthint"){
        ...
        document.getElementById("ModalFooterDiv").style.backgroundColor="orangered"
			...
			document.getElementById("whatsappshare").innerHTML = `Share on Whatsapp`
			document.getElementById("whatsappshare").href="whatsapp://send?text="+scoreboard+"%0a"+"Khardal Score Waaz 2: "+score_n+"%0a"+"https://khardal.net/";
